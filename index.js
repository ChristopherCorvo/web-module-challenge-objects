...
/* Task 4: Add a new rating with your (fictitious) opinions of the restaurant in the same format as the reviews above. */
  ...
  reviews.push({
    name: "Christopher",
    rating: 3,
    feedback: "I wish there has been a panda in the place."
  });
...
function getLastReview(array) {
    ...
    return `${array[index].name} gave the restaurant a ${array[index].rating} star rating, and their feedback was: ${array[index].feedback}`
